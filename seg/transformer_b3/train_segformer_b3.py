...
try:
  ...
  raise RuntimeError("torch is required for SegFormer-B3 fine-tuning") from exc
...
def main() -> int:
  ...
  print("2) run 06_BUILD_FINAL_EVIDENCE_ONLY.bat after both checkpoints exist")
  return 0
