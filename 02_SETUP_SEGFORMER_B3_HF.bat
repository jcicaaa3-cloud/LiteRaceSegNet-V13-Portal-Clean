...
echo [LICENSE NOTE] SegFormer-B3 is an optional comparison baseline only.
echo [RELEASE NOTE] Downloaded/cache artifacts stay in the local comparison environment.
...
echo  TRAIN_SEGFORMER_B3_ONLY.bat
echo.
if not defined NO_PAUSE pause